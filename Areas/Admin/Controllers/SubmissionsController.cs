...
namespace EnglishCenterMVC.Areas.Admin.Controllers
{
    ...
    public class SubmissionsController : Controller
    {
        ...
        public SubmissionsController(IAssignmentService assignmentService, ISubmissionService submissionService)
        {
        ...
        {
            var dataContext = await submissionService.GetSubmissions();
        ...
        {
            ViewData["AssignmentId"] = new SelectList(await assignmentService.GetAssignmentsAsync(), "Id", "Title");
            return View();
        }
